...
public class ClientModelTracker {
    ...
    public void handleDictUpdate(int index, String dictKey, Object value) {
        if (value == null) {
            log.warning("ClientModelTracker: handleDictUpdate received null value for index=" + index + ", key=" + dictKey);
            return;
        }
        log.info("ClientModelTracker: handleDictUpdate: index=" + index + ", key=" + dictKey + ", value=" + value);
    ...
    public Object getValueByIndex(int index) {
        ...
        Object value = key == null ? null : valueMap.get(key);
        log.info("ClientModelTracker: getValueByIndex: index=" + index + ", key=" + key + ", value=" + value);
        return value;
    }
